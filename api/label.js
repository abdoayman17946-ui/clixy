...
<header class="header"><div><img class="logo" src="${logoUrl}" alt="CLIXY"></div><div class="headCenter"><div class="small">رقم البوليصة</div><div class="orderNo"><span class="hash">#</span>${esc(orderNo)}</div></div><div class="qrbox"><img class="qr" src="${qrUrl}" alt="QR"><div class="qrurl">linktr.ee/clixy.eg</div></div></header>
...
function render(){
  ...
  document.getElementById("notes").textContent=d.notes||"يرجى التعامل مع الطلب بعناية";
...
function saveEdit(){
 ...
 localStorage.setItem(ORDER_KEY,JSON.stringify(d));render();closeEdit();
}
render();
</script></body></html>`);
  } catch(e) {
