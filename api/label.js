...
.modal{display:none;position:fixed;inset:0;background:rgba(0,0,0,.55);z-index:100;align-items:center;justify-content:center}.modal.open{display:flex}.panel{background:#fff;width:min(720px,94vw);max-height:92vh;overflow:auto;padding:18px;border-radius:16px}.panel h3{margin:0 0 14px}.field{margin:9px 0}.field label{display:block;font-size:12px;font-weight:700;margin-bottom:4px}.field input,.field textarea{width:100%;padding:9px;border:1px solid #bbb;border-radius:8px;font-family:inherit}.row{display:grid;grid-template-columns:1fr 1fr;gap:8px}.productsEdit{width:100%;border-collapse:collapse;font-size:11px}.productQrPanel{display:flex;flex-direction:row;direction:ltr;align-items:center;justify-content:space-between;gap:5mm;border:1px solid #aaa;border-radius:2mm;padding:2mm;min-height:24mm}.productQr{order:1;width:13mm;height:13mm;object-fit:contain;border:1px solid #bbb;padding:.5mm;border-radius:1.5mm;transform:none;flex:none}.productDescBox{order:2;flex:1;text-align:right;direction:rtl;min-width:0;border-right:1px dashed #ccc;padding-right:4mm}.productDesc{font-size:7.2px;line-height:1.35;white-space:pre-wrap;word-break:break-word;max-height:17mm;min-height:12mm;overflow:hidden}
...
render();
const AUTO_EDIT = new URLSearchParams(window.location.search).get("edit") === "1";
if(AUTO_EDIT) setTimeout(()=>{ try { openEdit(); } catch(e) { console.error(e); } }, 80);
</script></body></html>