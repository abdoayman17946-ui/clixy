...
PRODUCT VISIBILITY FIX: kept the original V5.6 design; product rows now get density styling from 4 items onward and are automatically fitted to the available product area without hiding rows. Tested with 4, 7, 10, 20 and 50 products; all rows remained in the DOM and the table was fitted to its container.
